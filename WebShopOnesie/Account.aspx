<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Account.aspx.cs" Inherits="MyProject.Account" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table> 
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TextBox3" BorderColor="#CC3300" Enabled="False"
                    Font-Bold="True" ForeColor="Red" runat="server" Height="22px" Width="189px"></asp:TextBox>
